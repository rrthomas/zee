...
call_command ("execute-kbd-macro", "\\C-xbtestbuf\\rget this\\r\\C-xb\\r")
...
call_command ("execute-kbd-macro", "\\C-xbtestb	\\rleave this\\r\\M-gg1\\r\\C-k\\C-k\\C-xb\\r\\C-y\\C-x\\C-s\\C-x\\C-c")
